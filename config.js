...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/MPjbBA9.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;🇱🇷⃞⍣ꪶ͢ 𝐗͎͢𝛐⃡𝛍⃐𝐥ꪆꪶ͢ 𝐒ᴇ⃮ʀ𝄠 ⃞͢🇭🇲;0;https://i.imgur.com/MPjbBA9.jpeg;https://i.imgur.com/MPjbBA9.jpeg',
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '🇱🇷⃞⍣ꪶ͢ 𝐗͎͢𝛐⃡𝛍⃐𝐥ꪆꪶ͢ 𝐒ᴇ⃮ʀ𝄠 ⃞͢🇭🇲;https://i.imgur.com/MPjbBA9.jpeg' : process.env.AUDIO_DATA,
